...
class CategoriesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        /*  [we make a local scope in model]
        ...
        // $filteredResults = Category::filter($request);
        $filteredResults = Category::leftjoin('categories as parents', 'parents.id', '=', 'categories.parent_id')->filter($request->query());
        // $categories = Category::paginate(5);
        $categories = $filteredResults->paginate(5);
