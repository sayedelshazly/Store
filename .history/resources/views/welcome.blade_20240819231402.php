...
<head>
    ...
    <title>test DevMode</title>

    <style>

        :root{
            --sds-size-space-1600:600px;
            --layout-margins:96px;
            --sds-size-space-600:60px;
            --sds-responsive-device-width:100%;
            --hight-hero-sm:6131px;
            --sds-size-space-800:80px;
            --sds-size-space-2400:25px;
            --width-card-lg:;
            --sds-size-space-400:49px;
            --sds-size-space-200:20px;

        }
        .layout {
            display: flex;
            padding: var(--sds-size-space-1600) var(--layout-margins, 96px);
        ...
        .about {
            ...
            max-height: var(--hight-hero-sm, 631px);
            padding: var(--sds-size-space-2400) var(--layout-margins, 96px);
            flex-direction: column;
            justify-content: center;
            align-items: center;
            gap: var(--sds-size-space-800);

            background-image: url('/Hero Image.png'), linear-gradient(lightgray, lightgray);
            background-position: center;
        ...
        .button {
            display: flex;
            max-width: var(--width-card-lg, 400px);
