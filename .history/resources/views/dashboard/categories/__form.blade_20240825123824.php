...
<div class="class-group">
    ...
    <x-form.input label="Category Name" class="" name="name" type="text" :value="$category->name" /> {{-- :value (for
    expression or variable or function) --}}
</div>
...
<div class="class-group">
    <div>
        <x-form.radio label="Status" name="status" :checked="$category->status"
