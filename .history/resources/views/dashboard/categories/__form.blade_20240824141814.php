...
<div class="form-group">
    ...
    <select name="parent_id" id="" class="form-control form-select @error('name') is-invalid @enderror">
...
<div class="class-group">
    ...
    <textarea name="description" class="form-control @error('descrit') is-invalid @enderror"> {{old('description', $category->description)}} </textarea>
