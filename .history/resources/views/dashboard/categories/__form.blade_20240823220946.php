...
<div class="class-group">
    ...
    <div>
        <div class="form-check">
            <input class="form-check-input" type="radio" name="status" value="active" @checked(old('status') ?? $category->name  ==
            'active')>
        ...
        <div class="form-check">
            <input class="form-check-input" type="radio" name="status" value="archived" @checked(old('status') ?? $category->name ==
            'archived')>
            <label class="form-check-label">
                Archive
            </label>
