...
<div class="class-group">
    ...
    <div>
        <div class="form-check">
            <input class="form-check-input" type="radio" name="status" value="active" @checked(old ==
            'active')>
        ...
        <div class="form-check">
            <input class="form-check-input" type="radio" name="status" value="archived" @checked(old ==
            'archived')>
            <label class="form-check-label">
                Archive
            </label>
